...
@section('content')
    ...
    <!-- **********************************************************************************************************************************************************
      ...
      <section class="wrapper">
       <div class="row mt">
          <div class="col-lg-12">
            <h4><i class="fa fa-angle-right"></i> Thêm Nhân Viên</h4>
            <div class="form-panel">
              ...
              <div class="form">
                @csrf
                <form class="cmxform form-horizontal style-form" id="signupForm" method="post" enctype="multipart/form-data" action="e-stu/qlnv/xulythem">
                  <div class="form-group ">
                    <label for="tenkh" class="control-label col-lg-2">Tên Nhân Viên</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="tennv" name="tennv" type="text" placeholder="Nhập tên nhân viên..."/>
                    </div>
                  </div>
                    <div class="form-group ">
               ...
               <div class="form-group ">
                  ...
                  <div class="form-group ">
                    <label for="confirm_password" class="control-label col-lg-2">Xác nhận lại mật khẩu</label>
                    <div class="col-lg-10">
